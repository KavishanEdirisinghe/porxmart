            ...
            <div class="side_bar_content">
                <div class="side_bar_top">
                    ...
                    <div class="sideBar_link">
                        ...
                        <a class="{{ Request::routeIs('farmer_dashboard') ? 'active' : '' }}"
                            href="{{ route('farmer_dashboard') }}"> <i class="bi bi-house-fill"></i>
                            <span>Dashboard</span></a>
                        <a class="{{ Request::routeIs('farm_land') ? 'active' : '' }}"
                            href="{{ route('farm_land') }}"> <i class="bi bi-pin-map-fill"></i>
                            <span>Farm Land</span></a>
                        <a class="{{ Request::routeIs('paddy_product_index') ? 'active' : '' }}"
                            href="{{ route('paddy_product_index') }}"> <i class="fa fa-leaf" aria-hidden="true"></i>
                            <span>Paddy Product</span></a>
            ...
            <div class="nav_bar shadow-sm">
                <div class="nav_content">
                    ...
                    <div class="items">
                        ...
                        <div class="user">
                            <div class="img">
                                <img src="{{ asset('asset/images/role_1.jpeg') }}" alt="admin">
                            </div>
                            @if (session('farmer'))
                                <span class="name">{{ session('farmer')->fist_name }}</span>
                            @else
